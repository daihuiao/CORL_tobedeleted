...
#  python3 cql_federated.py --env "hopper-medium-v2" --seed 5 --num_agents 10 --device "cuda:1"
  python3 cql_federated.py --env "hopper-medium-v2" --seed 6 --num_agents 10 --device "cuda:1"
  python3 cql_federated.py --env "hopper-medium-v2" --seed 7 --num_agents 10 --device "cuda:1"
  python3 cql_federated.py --env "hopper-medium-v2" --seed 8 --num_agents 10 --device "cuda:1"
  python3 cql_federated.py --env "hopper-medium-v2" --seed 9 --num_agents 10 --device "cuda:1"
  python3 cql_federated.py --env "hopper-medium-v2" --seed 10 --num_agents 10 --device "cuda:1"
  python3 cql_federated.py --env "hopper-medium-v2" --seed 11 --num_agents 10 --device "cuda:1"
elif [ $1 = 2 ]; then
